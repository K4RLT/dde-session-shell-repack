 ...
 * Command line was: qdbusxml2cpp-fix -p /home/Karl/Documents/dde-session-shell-snipe/src/global_util/dbus/systempower1interface /home/Karl/Documents/dde-session-shell-snipe/xml/snipe/org.deepin.dde.SystemPower1.xml
 *
...
#include "/home/Karl/Documents/dde-session-shell-snipe/src/global_util/dbus/systempower1interface.h"

DCORE_USE_NAMESPACE
/*
 * Implementation of interface class __OrgDeepinDdePower1Interface
 */

class __OrgDeepinDdePower1InterfacePrivate
{
public:
   __OrgDeepinDdePower1InterfacePrivate() = default;
...
__OrgDeepinDdePower1Interface::__OrgDeepinDdePower1Interface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
    : DDBusExtendedAbstractInterface(service, path, staticInterfaceName(), connection, parent)
    , d_ptr(new __OrgDeepinDdePower1InterfacePrivate)
{
    connect(this, &__OrgDeepinDdePower1Interface::propertyChanged, this, &__OrgDeepinDdePower1Interface::onPropertyChanged);

}

__OrgDeepinDdePower1Interface::~__OrgDeepinDdePower1Interface()
{
    qDeleteAll(d_ptr->m_processingCalls.values());
    delete d_ptr;
}

void __OrgDeepinDdePower1Interface::onPropertyChanged(const QString &propName, const QVariant &value)
{
...
void __OrgDeepinDdePower1Interface::setPowerSavingModeBrightnessDropPercent(uint value)
{
...
bool __OrgDeepinDdePower1Interface::powerSystemAutoToSleepWhenFree()
{
...
void __OrgDeepinDdePower1Interface::CallQueued(const QString &callName, const QList<QVariant> &args)
{
    ...
    if (d_ptr->m_processingCalls.contains(callName))
    {
        ...
        connect(watcher, &QDBusPendingCallWatcher::finished, this, &__OrgDeepinDdePower1Interface::onPendingCallFinished);
        d_ptr->m_processingCalls.insert(callName, watcher);
    }
}

void __OrgDeepinDdePower1Interface::onPendingCallFinished(QDBusPendingCallWatcher *w)
{
    w->deleteLater();
