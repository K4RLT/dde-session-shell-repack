 ...
 * Command line was: qdbusxml2cpp-fix -p /home/Karl/Documents/dde-session-shell-snipe/src/global_util/dbus/wminterface /home/Karl/Documents/dde-session-shell-snipe/xml/snipe/com.deepin.wm.xml
 *
...
#include "/home/Karl/Documents/dde-session-shell-snipe/src/global_util/dbus/wminterface.h"

DCORE_USE_NAMESPACE
/*
 * Implementation of interface class __ComDeepinWmInterface
 */

class __ComDeepinWmInterfacePrivate
{
public:
   __ComDeepinWmInterfacePrivate() = default;
...
__ComDeepinWmInterface::__ComDeepinWmInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent)
    : DDBusExtendedAbstractInterface(service, path, staticInterfaceName(), connection, parent)
    , d_ptr(new __ComDeepinWmInterfacePrivate)
{
    connect(this, &__ComDeepinWmInterface::propertyChanged, this, &__ComDeepinWmInterface::onPropertyChanged);

    if (QMetaType::fromName("QList<uint>").id() == QMetaType::UnknownType) {
        qRegisterMetaType< QList<uint> >("QList<uint>");
        qDBusRegisterMetaType< QList<uint> >();
    }
}

__ComDeepinWmInterface::~__ComDeepinWmInterface()
{
    qDeleteAll(d_ptr->m_processingCalls.values());
    delete d_ptr;
}

void __ComDeepinWmInterface::onPropertyChanged(const QString &propName, const QVariant &value)
{
...
bool __ComDeepinWmInterface::compositingAllowSwitch()
{
    return qvariant_cast<bool>(internalPropGet("compositingAllowSwitch", &d_ptr->compositingAllowSwitch));
}

bool __ComDeepinWmInterface::compositingEnabled()
{
...
void __ComDeepinWmInterface::CallQueued(const QString &callName, const QList<QVariant> &args)
{
    ...
    if (d_ptr->m_processingCalls.contains(callName))
    {
        ...
        connect(watcher, &QDBusPendingCallWatcher::finished, this, &__ComDeepinWmInterface::onPendingCallFinished);
        d_ptr->m_processingCalls.insert(callName, watcher);
    }
}

void __ComDeepinWmInterface::onPendingCallFinished(QDBusPendingCallWatcher *w)
{
    w->deleteLater();
