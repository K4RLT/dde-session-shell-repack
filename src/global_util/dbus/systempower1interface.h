...
#ifndef SYSTEMPOWER1INTERFACE_H
#define SYSTEMPOWER1INTERFACE_H
...
class __OrgDeepinDdePower1Interface : public DTK_CORE_NAMESPACE::DDBusExtendedAbstractInterface
{
    Q_OBJECT
...
public:
    explicit __OrgDeepinDdePower1Interface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

    ~__OrgDeepinDdePower1Interface();
...
private:
    __OrgDeepinDdePower1InterfacePrivate *d_ptr;
};

namespace org {
  namespace deepin {
    namespace dde {
      typedef ::__OrgDeepinDdePower1Interface Power1;
    }
  }
}
#endif
