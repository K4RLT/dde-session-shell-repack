...
#ifndef WMINTERFACE_H
#define WMINTERFACE_H
...
class __ComDeepinWmInterface : public DTK_CORE_NAMESPACE::DDBusExtendedAbstractInterface
{
    Q_OBJECT
...
public:
    explicit __ComDeepinWmInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

    ~__ComDeepinWmInterface();
...
private:
    __ComDeepinWmInterfacePrivate *d_ptr;
};

namespace com {
  namespace deepin {
    typedef ::__ComDeepinWmInterface wm;
  }
}
#endif
