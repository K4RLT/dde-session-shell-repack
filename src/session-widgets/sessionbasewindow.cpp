...
void SessionBaseWindow::setSubCenterWidget(QWidget *const widget)
{
    if (m_subCenterWidget != nullptr) {
        m_centerVLayout->removeWidget(m_subCenterWidget);
        m_subCenterWidget->hide();
    }
    m_centerVLayout->addWidget(widget, 0, Qt::AlignHCenter);
    m_subCenterWidget = widget;
}
